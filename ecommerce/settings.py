...
# # Login URLs (fix the /accounts/login/ issue)
# LOGIN_URL = '/customerlogin/'            # used by @login_required
# LOGIN_REDIRECT_URL = '/customer-home/'   # after login
# LOGOUT_REDIRECT_URL = '/customerlogin/'  # after logout
